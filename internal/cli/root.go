...
import (
	"fmt"
	"github.com/lucascustodio/newteste/internal/cli/pet"
	"github.com/lucascustodio/newteste/internal/cli/store"
	"github.com/lucascustodio/newteste/internal/cli/user"
	"github.com/lucascustodio/newteste/internal/config"
	"github.com/lucascustodio/newteste/internal/explorer"
...
func NewRootCommand() (*cobra.Command, error) {
	...
	rootCmd := &cobra.Command{
		Use:           "cli",
		Short:         "Petstore - OpenAPI 3",
		Long:          "Petstore - OpenAPI 3.1: This is a sample Pet Store Server based on the OpenAPI 3.1 specification.\n\nSome useful links:\n- [OpenAPI Reference](https://www.speakeasy.com/openapi)\n- [The Pet Store repository](https://github.com/swagger-api/swagger-petstore)\n- [The source API definition for the Pet Store](https://github.com/swagger-api/swagger-petstore/blob/master/src/main/resources/openapi.yaml)",
		SilenceUsage:  true,
		SilenceErrors: true,
	...
	if err := pet.InitPetRoot(rootCmd); err != nil {
		return nil, fmt.Errorf("init pet: %w", err)
	}
	if err := store.InitStoreRoot(rootCmd); err != nil {
	...
	rootCmd.PersistentFlags().String("environment", "", "Server template variable: environment")
	_ = rootCmd.PersistentFlags().SetAnnotation("environment", "speakeasy:group", []string{"Server"})
