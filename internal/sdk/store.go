...
func newStore(rootSDK *Petstore, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Store {
	return &Store{
		rootSDK:          rootSDK,
...
func (s *Store) DeleteOrder(ctx context.Context, request operations.DeleteOrderRequest, opts ...operations.Option) (*operations.DeleteOrderResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
